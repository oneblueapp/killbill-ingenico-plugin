...
public class IngenicoPaymentMethodInfoPlugin extends PluginPaymentMethodInfoPlugin {

    public IngenicoPaymentMethodInfoPlugin(final IngenicoPaymentMethodsRecord record) {
        super(UUID.fromString(record.getKbAccountId()),
              UUID.fromString(record.getKbPaymentMethodId()),
              record.getIsDefault() == IngenicoDao.TRUE,
              record.getToken());
    }
}
